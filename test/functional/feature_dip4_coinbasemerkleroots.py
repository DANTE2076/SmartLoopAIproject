...
class LLMQCoinbaseCommitmentsTest(SmartLoopAITestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as SmartLoopAITestFramework doesn't support this atm)
