...
"""Verify that starting smartloopaid with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start smartloopaid with -h for help text")
        ...
        self.log.info("Start smartloopaid with -version for version information")
        ...
        self.log.info("Start smartloopaidd with -fakearg to make sure it does not start")
