# SmartLoopAI Core version v19.3.0
...
- `wipetxes`: New command for `smartloopai-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/SmartLoopAIproject/compare/v19.2.0...smartloopaipay:v19.3.0).
