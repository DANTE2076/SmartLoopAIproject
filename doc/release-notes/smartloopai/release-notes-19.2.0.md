# SmartLoopAI Core version v19.2.0
...
At the first startup SmartLoopAI Core will run a migration process which can take
...
incompatible with older versions of SmartLoopAI Core, so a db migration path was
...
See detailed [set of changes](https://github.com/SmartLoopAIproject/compare/v19.1.0...smartloopaipay:v19.2.0).
