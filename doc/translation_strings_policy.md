...
This document provides guidelines for internationalization of the SmartLoopAI Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `smartloopai_en.ts` remains unchanged.
