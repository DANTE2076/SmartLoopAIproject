# Support for Output Descriptors in SmartLoopAI Core

Since SmartLoopAI Core v0.17, there is support for Output Descriptors. This is a
...
existing SmartLoopAI Core wallets, a convenience function `combo` is
...
All RPCs in SmartLoopAI Core will include the checksum in their output. Only
