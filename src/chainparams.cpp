 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1705922783, nBits=1e0ffff0, nNonce=128322, vtx=1)
...
{
    const char* pszTimestamp = "Jan 2024";
    const CScript genesisOutputScript = CScript() << ParseHex("0447cb28e942398425b2e6432160d6eeb2976261592eb8bfc58a6a56c603c048d20e654121c9b1fc4c1fb308c1f975139e41daf485647ce0efcc8763242205d478") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000007cf9a812b00acc3c860d504d065245794f48f2234fad9cbd615d497f314"); 
        ...
        genesis = CreateGenesisBlock(1705922783, 128322, 0x1e0ffff0, 1, 400 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000007cf9a812b00acc3c860d504d065245794f48f2234fad9cbd615d497f314"));
        assert(genesis.hashMerkleRoot == uint256S("0xed940e107ed78ec4ce470fd35783e001252574349ed9007bea843bcfdd5720c6"));
        ...
        vSporkAddresses = {"SXxWtpjNid8MxykqQCNjcrjr4i5nywq2J4"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x000007cf9a812b00acc3c860d504d065245794f48f2234fad9cbd615d497f314")},
                {42, uint256S("000001dd92ab9370affb110979d04b0b7300fa6bc8cfe3386fd391d1e74c8c84")},
                {375, uint256S("00000000000418d946a3d9eea97afcdf18fe06fb559635053060aecb3c1bc50e")},
                {833, uint256S("00000000000000132f8c8c18be240b031e7b5eaecd233901a9b14a04d5acce0c")},
                {1526, uint256S("0000000000000010bd1d3d41b16c051000570a4d87b799c2a819788847352d45")},
                {2318, uint256S("00000000000000149831e09f354cfc49405793951409a71fd28336dea2b53b1d")},   
                {3590, uint256S("00000000000002f8b40763c19a94c0030e12ba13aefacf1dbe582a30c70e487d")},
            }
        };
        ...
        // getchaintxstats 17280 000007cf9a812b00acc3c860d504d065245794f48f2234fad9cbd615d497f314
        chainTxData = ChainTxData{
                1705922783, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000ebff33266e7e8af2ff573a56535992aa8c590e94d3d8e13e885f0258f8c"); 
        ...
        genesis = CreateGenesisBlock(1705922788UL, 640736UL, 0x1e0ffff0, 1, 400 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000ebff33266e7e8af2ff573a56535992aa8c590e94d3d8e13e885f0258f8c"));
        assert(genesis.hashMerkleRoot == uint256S("0xed940e107ed78ec4ce470fd35783e001252574349ed9007bea843bcfdd5720c6"));
        ...
        vSporkAddresses = {"TVeaqZCBFebkXkYhQCSqQuQDEYdSUdPLWE"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000ebff33266e7e8af2ff573a56535992aa8c590e94d3d8e13e885f0258f8c")},
            }
        };
        ...
        // getchaintxstats 17280 00000ebff33266e7e8af2ff573a56535992aa8c590e94d3d8e13e885f0258f8c
        chainTxData = ChainTxData{
                1705922788, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1705922793, 2, 0x207fffff, 1, 400 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x1b0ce23436eccd0f1d40a5553a2f421f856e9f5ba5666809f94251a82938bd0d"));
        assert(genesis.hashMerkleRoot == uint256S("0xed940e107ed78ec4ce470fd35783e001252574349ed9007bea843bcfdd5720c6"));

        devnetGenesis = FindDevNetGenesisBlock(genesis, 400 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x1b0ce23436eccd0f1d40a5553a2f421f856e9f5ba5666809f94251a82938bd0d")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 7VmiWkNmS8pnujXm9NNkTY6DirWkDHPbbppbqYGDNokXnnH2BbS
        vSporkAddresses = {"TRJgaBJh3frepkwhvqXZotWTT1Cq43KeFM"};
        nMinSporkKeys = 1;
