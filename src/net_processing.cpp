 ...
 *  We have 4 times smaller block times in SmartLoopAI, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        SmartLoopAI Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // SMLP this code also handles non-TXs (SmartLoopAI specific messages)
