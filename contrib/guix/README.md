# Bootstrappable SmartLoopAI Core Builds

This directory contains the files necessary to perform bootstrappable SmartLoopAI
Core builds.
...
To build SmartLoopAI Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      SmartLoopAI Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/smartloopai-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/smartloopaipay/guix.sigs).
...
[guix-docker]: https://github.com/SmartLoopAIproject/tree/master/contrib/guix/Dockerfile
